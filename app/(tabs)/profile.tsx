...
import {
  Bell,
  Camera,
  CheckCircle2, // Import name remains LogOut to match library export
  ChevronRight,
  Copy,
  Droplets,
  Facebook,
...
const styles = StyleSheet.create({
  ...
  sevaItem: { alignItems: 'center', marginRight: 20, width: 80, position: 'relative', paddingTop: 10, paddingRight: 10 },
...
deleteSevaIcon: { position: 'absolute',top: 0,right: 0,backgroundColor: '#ef4444',borderRadius: 10,padding: 2,zIndex: 10,},
