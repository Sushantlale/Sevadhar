...
const headerImage = require("../../assets/images/History_new.png");
      ...
      <View style={styles.outerContainer}>
        ...
        >
          ...
          <View style={styles.headerWrapper}>
            ...
            >
              <LinearGradient
                colors={["rgba(255,255,255,0)", "rgba(255,243,230,0.8)"]}
          ...
          <View style={styles.contentArea}>
            ...
            <View style={styles.actionHeader}>
              <TouchableOpacity onPress={() => setIsDeleteMode(!isDeleteMode)}>
                <Text style={styles.actionHeaderText}>
                  {isDeleteMode ? "Cancel" : "Select to Delete"}
                </Text>
              </TouchableOpacity>
            ...
            <View style={styles.listContainer}>
              {filteredHistory.map((item, index) => {
                const showMonth =
                  index === 0 ||
                  item.month !== filteredHistory[index - 1].month;
                ...
                return (
                  <View key={item.id}>
                    ...
                    <TouchableOpacity
                      activeOpacity={0.9}
                      onPress={() =>
                        isDeleteMode ? toggleSelection(item.id) : null
                      }
        ...
        <Modal transparent visible={voiceModal} animationType="fade">
          <View style={styles.voiceOverlay}>
            <View style={styles.voiceModal}>
              ...
              <TouchableOpacity
                style={styles.micButtonModal}
                onPress={startMockListening}
              >
