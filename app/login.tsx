...
const styles = StyleSheet.create({
    ...
    brandContainer: { alignItems: 'center', marginTop: 20, marginBottom: 40 },
    ...
    submitBtnText: { color: '#FFF', fontWeight: '800', fontSize: 20 },
    forgotBtn: { marginTop: 20, marginBottom: 10, alignItems: 'center' },
    forgotText: { color: '#FF7A00', fontSize: 16, fontWeight: '700' },
    footer: { flexDirection: 'row', justifyContent: 'center', marginTop: 10 },
    footerText: { fontSize: 15, color: '#64748B' },
    signUpLink: { fontSize: 15, color: '#FF7A00', fontWeight: '800' },
});